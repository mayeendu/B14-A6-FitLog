...
const PlansPage = () => {
  const { todayPlan, savedExercises, removeFromTodayPlan, removeFromSaved } =
    useFitness();
        ...
        <div className="mt-10 flex justify-center">
          <div className="flex rounded-xl border border-[#2d3038] bg-[#17181e] p-1">
            ...
            <button
              ...
              className={`rounded-lg px-5 py-3 text-sm font-bold transition sm:px-7 ${
                activeTab === "today"
            ...
            {exercises.map((exercise) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Equipment */}
                  <p className="mt-3 text-[#9ca3af]">{exercise.equipment}</p>
