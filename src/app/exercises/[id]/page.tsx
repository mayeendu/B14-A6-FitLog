      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            {/* Title */}
            <div>
              <h1 className="text-4xl font-medium font-oswald uppercase leading-none tracking-tight sm:text-5xl">
                {exercise.name}
              </h1>
            ...
            <div className="mt-7 overflow-hidden rounded-2xl border border-[#292c34] bg-[#17181e]">
              ...
              <div className="flex items-center justify-between border-b border-[#292c34] px-5 py-4">
                ...
                <span className="text-sm text-[#e5e7eb]">{exercise.sets}</span>
              </div>
              ...
              <div className="flex items-center justify-between border-b border-[#292c34] px-5 py-4">
                ...
                <span className="text-sm text-[#e5e7eb]">{exercise.reps}</span>
              </div>
