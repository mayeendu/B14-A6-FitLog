    ...
    <section className="bg-bg-primary container mx-auto border-b border-[#2d3038]">
      <div className="relative flex justify-between items-center p-4 sm:px-6 lg:px-8 bg-bg-primary text-white">
        ...
        <Link href="/" className="flex items-center space-x-2">
          ...
          <div className="font-oswald text-xl font-medium">FITLOG</div>
        </Link>
        ...
        <div className="hidden sm:flex space-x-2 md:space-x-4">
          ...
          >
            <div className="flex justify-between gap-2">
              <div> Plan </div>
              <div className="flex font-inter h-8 w-8 items-center justify-center rounded-full bg-brand-secondary font-bold text-black">
                {todayPlan.length}
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex justify-between gap-2">
              <div>Saved </div>{" "}
              <div className="flex font-inter h-8 w-8 items-center justify-center rounded-full border-2 border-gray-700 font-bold text-white">
