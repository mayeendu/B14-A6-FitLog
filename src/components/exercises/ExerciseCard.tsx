    ...
    <Link href={`/exercises/${exercise.id}`}>
      <article className="overflow-hidden rounded-[28px] border border-[#2d3038] bg-[#16171c] text-white shadow-sm transition duration-300 hover:-translate-y-1 hover:border-[#baff00]">
        ...
        <div className="px-7 py-7">
          ...
          {/* Exercise Name */}
          <h3 className="mt-8 text-3xl font-oswald font-medium uppercase leading-none tracking-wide">
            {exercise.name}
          </h3>

          {/* Equipment */}
          <p className="mt-5 text-lg text-[#a3a7b5]">{exercise.equipment}</p>
          ...
          <div className="flex items-center justify-between gap-4 text-[#a3a7b5]">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg">{exercise.duration} min</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg">{exercise.caloriesBurned} kcal</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg">{exercise.rating}</span>
            </div>
          </div>
        </div>
      </article>
